    ...
    <main className="stage-bg min-h-screen px-4 py-6 sm:px-10 sm:py-10">
      <section className="panel-shell mx-auto max-w-6xl px-6 py-8 sm:px-10 sm:py-10">
        ...
        <div className="mx-auto mb-12 max-w-3xl text-center fade-in-up">
          ...
          <h1 className="display-font mb-4 text-4xl font-extrabold uppercase text-ink-heading sm:text-5xl">지금 이사하는 게 맞을까?</h1>
        ...
        <div className="mx-auto mt-14 max-w-4xl space-y-6">
          <h2 className="display-font text-2xl font-bold uppercase text-ink-heading">이사 전 체크리스트</h2>
          ...
          <p className="text-ink-result"><strong>Q. 기분 전환용 이사는 괜찮을까?</strong><br />A. 가능하지만 비용이 큰 결정입니다. 감정 해소 목적이라면 단기 여행/생활 루틴 변경으로 먼저 테스트해보는 게 안전합니다.</p>
          <p className="text-ink-result"><strong>Q. 월세만 보고 결정해도 될까?</strong><br />A. 아니요. 교통비, 이동시간, 주변 인프라, 생활 스트레스까지 합산해야 실제 체감이 맞습니다.</p>
          <p className="text-ink-result"><strong>Q. 언제가 가장 좋은 이사 타이밍일까?</strong><br />A. 계약·직장 일정이 겹치지 않는 시점이 좋습니다. 준비 기간 4주 이상 확보하면 실수 비용이 줄어듭니다.</p>
