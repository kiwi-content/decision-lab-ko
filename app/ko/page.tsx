    ...
    <main className="stage-bg min-h-screen px-4 py-6 sm:px-10 sm:py-10">
      ...
      <section className="panel-shell mx-auto max-w-6xl bg-[#fffff5] px-6 py-7 sm:px-10 sm:py-10">
        ...
        <div id="simulators" className="grid gap-5 md:grid-cols-2 scroll-mt-20">
          <Link href="/text-my-ex" className="card-pop decision-card fade-in-up relative bg-[#f893e1]/30 p-6 pr-24 sm:pr-28">
            <CardClickHint className="decision-card-hint pointer-events-none absolute right-4 top-4" />
          ...
          <Link href="/quit-my-job" className="card-pop decision-card fade-in-up relative bg-[#80caff]/30 p-6 pr-24 sm:pr-28">
            <CardClickHint className="decision-card-hint pointer-events-none absolute right-4 top-4" />
          ...
          <Link href="/break-up" className="card-pop decision-card fade-in-up relative bg-[#a180ff]/24 p-6 pr-24 sm:pr-28">
            <CardClickHint className="decision-card-hint pointer-events-none absolute right-4 top-4" />
          ...
          <Link href="/move" className="card-pop decision-card fade-in-up relative bg-[#91e5b3]/28 p-6 pr-24 sm:pr-28">
            <CardClickHint className="decision-card-hint pointer-events-none absolute right-4 top-4" />
        ...
        <div className="mt-5">
          <div className="grid gap-5 md:grid-cols-2">
            <Link href="/throw-away" className="card-pop decision-card fade-in-up relative block bg-[#ffe878]/42 p-6 pr-24 sm:pr-28">
              <CardClickHint className="decision-card-hint pointer-events-none absolute right-4 top-4" />
            ...
            <Link href="/small-choices" className="card-pop decision-card fade-in-up relative block bg-[#ffc7a3]/40 p-6 pr-24 sm:pr-28">
              <CardClickHint className="decision-card-hint pointer-events-none absolute right-4 top-4" />
